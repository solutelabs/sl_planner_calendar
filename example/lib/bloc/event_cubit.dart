...
class EventCubit extends Cubit<EventState> {
  ...
  void getTrendingMovies() async {
    try {
      ...
      _events = [
        TimetableItem(DateTime(now.year, now.month, now.day, 9, 30),
        ...
        TimetableItem(DateTime(now.year, now.month, now.day, 9, 45),
            ...
            data: Event(
                ...
                documents: ['documents.pdf'])),
        TimetableItem(DateTime(now.year, now.month, now.day, 11, 0),
            ...
            data: Event(
                ...
                documents: ['documents.pdf'])),
        TimetableItem(DateTime(now.year, now.month, now.day, 13, 30),
        ...
        //second column
        TimetableItem(DateTime(now.year, now.month, now.day + 1, 9, 30),
            ...
            data: Event(
                ...
                color: const Color(0xFF123CBB).withOpacity(0.30),
                documents: ['documents.pdf'])),
        TimetableItem(DateTime(now.year, now.month, now.day + 1, 11, 00),
            ...
            data: Event(
                ...
                color: const Color(0xFFF2A93B).withOpacity(0.60),
                documents: ['documents.pdf'])),
        TimetableItem(DateTime(now.year, now.month, now.day + 1, 13, 30),
        ...
        ///third column
        TimetableItem(DateTime(now.year, now.month, now.day + 2, 9, 45),
            ...
            data: Event(
                ...
                documents: ['documents.pdf'])),
        TimetableItem(DateTime(now.year, now.month, now.day + 2, 11, 30),
  ...
  addEvent(TimetableItem<Event> value) async {
    emit(AddeingEvent());
